          ...
          <div class="col-sm-12">
            <form class="form-horizontal" method="post">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-10">
                  <input type="text" class="form-control" readonly name = "name" value="${requestScope.customer.getName()}">
                </div>
              </div>
              <div class="form-group row">
                <label class="col-md-2 control-label"  for="example-email">Address</label>
                <div class="col-md-10">
                  <input type="email" id="example-email" readonly name="address" class="form-control" value="${requestScope.customer.getAddress()}">
                </div>
              </div>
              <div class="form-group row">
                <label class="col-md-2 control-label">Country</label>
                <div class="col-md-10">
                  <select name="idCountry" id="idCountry" class="form-control" readonly >
